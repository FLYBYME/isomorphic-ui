...
export const TypographySchema = z.object({
    variant: z.enum(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'body', 'caption', 'code']).optional().default('body'),
...
export type TypographyProps = IBaseUIProps & z.input<typeof TypographySchema>;
...
export class Typography extends BrokerComponent {
    ...
    public build(): ComponentChild {
        const props = this.props as TypographyProps;
